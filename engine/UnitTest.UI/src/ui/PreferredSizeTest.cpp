...
public:
    ...
    TEST_METHOD(PreferredSize_parseWrap) {
    ...
    TEST_METHOD(PreferredSize_parseWrapSpaces) {
        PreferredSize size = PreferredSize::parse(" wrap , wrap ");
        Assert::AreEqual(PreferredSize::Width::WRAP, size.width);
        Assert::AreEqual(PreferredSize::Height::WRAP, size.height);
    }

    TEST_METHOD(PreferredSize_parseFill) {
    ...
    TEST_METHOD(PreferredSize_parseValueZero) {
    ...
    TEST_METHOD(PreferredSize_parseValue) {
    ...
    TEST_METHOD(PreferredSize_parseValueComma) {
    ...
    TEST_METHOD(PreferredSize_parseValueF) {
        Assert::ExpectException<std::invalid_argument, void>([] {
    ...
    TEST_METHOD(PreferredSize_parseText) {
        Assert::ExpectException<std::invalid_argument, void>([] {
    ...
    TEST_METHOD(PreferredSize_parsePercentZero) {
        PreferredSize size = PreferredSize::parse("0.0%, 0.0%");
    ...
    TEST_METHOD(PreferredSize_parsePercent) {
        PreferredSize size = PreferredSize::parse("500.0%, 12.5%");
    ...
    TEST_METHOD(PreferredSize_parsePercentComma) {
        Assert::ExpectException<std::invalid_argument, void>([] {
            PreferredSize size = PreferredSize::parse("5,0%, wrap");
        });
        Assert::ExpectException<std::invalid_argument, void>([] {
    ...
    TEST_METHOD(PreferredSize_parsePercentSpace) {
        Assert::ExpectException<std::invalid_argument, void>([] {
            PreferredSize size = PreferredSize::parse("5.0 %, wrap");
        });
        Assert::ExpectException<std::invalid_argument, void>([] {
