...
namespace Ghurund::Core {
    ...
    const Type& getType<Ghurund::Engine::DirectX::DescriptorAllocator>() {
        static Type TYPE = Type("", "DescriptorAllocator", sizeof(Ghurund::Engine::DirectX::DescriptorAllocator));
        return TYPE;
    }

    template<>
    const Type& getType<Ghurund::Engine::DirectX::GPUResourceFactory>() {
        static Type TYPE = Type("", "GPUResourceFactory", sizeof(Ghurund::Engine::DirectX::GPUResourceFactory));
        return TYPE;
    }
}