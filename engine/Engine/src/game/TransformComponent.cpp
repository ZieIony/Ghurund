...
namespace Ghurund {
	Status TransformComponent::loadInternal(const DirectoryPath& workingDir, MemoryInputStream& stream, LoadOption options) {
	...
	Status TransformComponent::saveInternal(const DirectoryPath& workingDir, MemoryOutputStream& stream, SaveOption options) const {
