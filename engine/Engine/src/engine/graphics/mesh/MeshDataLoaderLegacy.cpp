#include "ghepch.h"
#include "MeshDataLoaderLegacy.h"
...
namespace Ghurund::Engine {
	...
	void MeshDataLoaderLegacy::loadObj(MeshData& mesh, MemoryInputStream& stream) {
	...
	void MeshDataLoaderLegacy::loadMesh(MeshData& mesh, MemoryInputStream& stream) {
	...
	CoroutineTask<void> MeshDataLoaderLegacy::loadInternal(
		MeshData& resource,
	...
	void MeshDataLoaderLegacy::saveInternal(
		MeshData& resource,
