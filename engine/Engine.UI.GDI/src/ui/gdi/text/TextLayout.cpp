...
namespace Ghurund::UI::GDI {
    ...
    void TextLayout::copySinglePropertyRange(IDWriteTextLayout* oldLayout, uint32_t startPosForOld, IDWriteTextLayout* newLayout, uint32_t startPosForNew, uint32_t length, Ghurund::UI::GDI::TextFormat* textFormat) {
    ...
    Ghurund::UI::TextFormat* TextLayout::getFormat(uint32_t position) {
        ...
        return ghnew Ghurund::UI::GDI::TextFormat(layout, size, fontWeight, fontStyle == DWRITE_FONT_STYLE_ITALIC, localeName.begin());
    }
