...
namespace Ghurund::UI {
    ...
    public:
        ...
        DarkTheme(FontCollectionLoader& fontLoader, IDWriteFactory& dwriteFactory, IResourceLoader& resourceLoader, uint32_t accent):BaseTheme(fontLoader, dwriteFactory, resourceLoader), color_accent(accent) {
