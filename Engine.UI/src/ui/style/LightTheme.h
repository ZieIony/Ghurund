...
namespace Ghurund::UI {
    ...
    public:
        ...
        LightTheme(FontCollectionLoader& fontLoader, IDWriteFactory& dwriteFactory, IResourceLoader& resourceLoader, const Color& accent = 0xff0078D7):BaseTheme(fontLoader, dwriteFactory, resourceLoader), color_accent(accent) {
