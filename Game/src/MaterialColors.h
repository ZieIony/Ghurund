...
namespace Material {
    ...
    public:
        Theme() {
            ...
            checkBoxChecked = ghnew Ghurund::UI::BitmapImage("icons/checkbox checked 18.png");
            checkBoxUnchecked = ghnew Ghurund::UI::BitmapImage("icons/checkbox unchecked 18.png");
            radioButtonChecked = ghnew Ghurund::UI::BitmapImage("icons/radiobutton checked 18.png");
            radioButtonUnchecked = ghnew Ghurund::UI::BitmapImage("icons/radiobutton unchecked 18.png");
        }
    };
