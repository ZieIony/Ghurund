...
namespace Demo {
	DemoWindow::DemoWindow(
		...
		ActionMapping.keyActions.put<XMFLOAT2>('w', *moveWindow.get(), { 0.0f, 1.0f });
		ActionMapping.keyActions.put<XMFLOAT2>('s', *moveWindow.get(), { 0.0f, -1.0f });
		ActionMapping.keyActions.put<XMFLOAT2>('a', *moveWindow.get(), { -1.0f, 0.0f });
		ActionMapping.keyActions.put<XMFLOAT2>('d', *moveWindow.get(), { 1.0f, 0.0f });
