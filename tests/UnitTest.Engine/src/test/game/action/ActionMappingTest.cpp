    ...
    public:
        ...
        TEST_METHOD(ActionMapping_noExecuteDispatches) {
            MemoryGuard guard;
            {
                ...
                mapping.gamepadButtonActions.put(0, GamepadButton::A, action.ref());
        ...
        TEST_METHOD(ActionMapping_addGamepadButton_otherGamepad) {
            MemoryGuard guard;
            {
                ActionMapping mapping;
                auto action = makeIntrusive<TestBoolAction>();
                mapping.gamepadButtonActions.put(1, GamepadButton::A, action.ref());
        ...
        TEST_METHOD(ActionMapping_addGamepadButton_otherButton) {
            MemoryGuard guard;
            {
                ActionMapping mapping;
                auto action = makeIntrusive<TestBoolAction>();
                mapping.gamepadButtonActions.put(0, GamepadButton::B, action.ref());
        ...
        TEST_METHOD(ActionMapping_addGamepadButton_transformer) {
            MemoryGuard guard;
            {
                ...
                mapping.gamepadButtonActions.put<float>(0, GamepadButton::A, action.ref(), [](bool value) { return value ? 1.0f : 0.0f; });
        ...
        TEST_METHOD(ActionMapping_addGamepadTrigger) {
            MemoryGuard guard;
            {
                ActionMapping mapping;
                auto action = makeIntrusive<TestFloatAction>();
                mapping.gamepadTriggerActions.put(0, GamepadTrigger::LEFT, action.ref());
        ...
        TEST_METHOD(ActionMapping_addGamepadStick) {
            MemoryGuard guard;
            {
                ...
                mapping.gamepadStickActions.put(0, GamepadStick::LEFT, action.ref());
        ...
        TEST_METHOD(ActionMapping_addKey) {
            MemoryGuard guard;
            {
                ActionMapping mapping;
                auto action = makeIntrusive<TestBoolAction>();
                mapping.keyActions.put('a', action.ref());
        ...
        TEST_METHOD(ActionMapping_addMouseButton) {
            MemoryGuard guard;
            {
                ActionMapping mapping;
                auto action = makeIntrusive<TestBoolAction>();
                mapping.mouseButtonActions.put(MouseButton::LEFT, action.ref());
