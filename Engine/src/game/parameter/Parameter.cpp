...
namespace Ghurund {
    ...
    const char *Parameter::AMBIENT_LIGHT = "ambientLight";

    const char *Parameter::POSITION = "position";
    const char *Parameter::ROTATION = "rotation";
    const char *Parameter::SCALE = "scale";

    const char *Parameter::CAMERA_DIRECTION = "cameraDirection";
    const char *Parameter::CAMERA_POSITION = "cameraPosition";
    const char *Parameter::CAMERA_TARGET = "cameraTarget";
    const char *Parameter::CAMERA_UP = "cameraUp";
    const char *Parameter::CAMERA_RIGHT = "cameraRight";
